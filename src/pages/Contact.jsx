...
const Contact = () => {
  ...
  return (
    <div className={`min-h-screen pt-24 pb-16 flex items-center justify-center ${isDark ? 'bg-gradient-to-b from-[#020617] via-[#0a0f1f] to-[#000D1A]/90 text-white' : 'bg-gradient-to-r from-[#f0f4f8] via-[#e2e8f0] to-[#cbd5e1] text-gray-900'}`}>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-xl backdrop-blur-md bg-white/5 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 animate-on-scroll stagger-1">
                  ...
                  <div>
                    ...
                    <p className={`${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      aryanvishwakarma2003@gmail.com
                    </p>
                  </div>
                </div>
