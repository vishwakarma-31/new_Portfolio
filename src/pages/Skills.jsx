    ...
    >
      <div className="max-w-7xl mx-auto space-y-12 pb-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className={`relative w-full overflow-hidden py-8 rounded-xl ${isDark ? 'bg-white/5' : 'bg-black/5'} backdrop-blur-lg border ${isDark ? 'border-white/10' : 'border-black/10'} shadow-lg`}
        >
...
const SkillCard = ({ category, index, isDark }) => {
  ...
  return (
    ...
    >
      <div className={`rounded-lg overflow-hidden shadow-md transition-transform duration-500 group-hover:scale-105 p-6 ${isDark ? 'bg-gradient-to-br from-slate-800 to-gray-900' : 'bg-gradient-to-br from-white to-gray-100'}`}>
